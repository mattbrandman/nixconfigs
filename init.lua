...
require('nixCatsUtils').setup {
  ...
  if require('nixCatsUtils').isNixCats then
    ...
    libs = { path = require('nixCats').nixCatsPath .. '/lua', words = { "nixCats" } }
  end
  ...
  require('nixCatsUtils.lazyCat').setup(pluginList, nixLazyPath,
  {
    ...
    require 'plugins.kickstart-default.autopairs',
    require 'plugins.kickstart-default.debug',
    require 'plugins.kickstart-default.gitsigns',
